...
//             <div onclick="backToSite()" class="back-arrow"><img class="back-arrow-img" src="assets/img/arrow-left-line.svg" alt=""></div>
//         </div>
//         <div class="privacy_policy-fulltext">
...
<div class="sideNav-policy-content">
    <a href="../privacy_policy.html"><span class="sideNav-policy">Privacy Policy</span></a>
    <a href="../legal_notice.html"><span class="sideNav-notice">Legal notice</span></a>
</div>`;
}
...
function renderHeader(firstLetter, id, renderClass) {
    ...
    <div class="header-user dropdown" onclick="dropDownMenu()">
        ...
        <a onclick="sideNavNotice('${id}', '${renderClass}')">Legal Notice</a>
        <a onclick="sideNavPolicy('${id}', '${renderClass}')">Privacy Policy</a>
